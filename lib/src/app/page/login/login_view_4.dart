...
class LoginView4 extends View{
  @override
  _LoginViewState4 createState() => _LoginViewState4();

}

class _LoginViewState4 extends ViewState<LoginView4, LoginController>{

  _LoginViewState4() : super(LoginController(DeviceHttpDatosRepositorio(), MoorConfiguracionRepository()));
