...
class ResultadoController extends Controller {
  ...
  ResultadoController(this.cursosUi, this._calendarioPeriodoUI,
      ConfiguracionRepository configuracionRepo,
      CalendarioPeriodoRepository calendarioPeriodoRepo,
      ResultadoRepository resultadoRepo, HttpDatosRepository httpDatosRepo) :
        this._presenter = ResultadoPresenter(
            configuracionRepo, calendarioPeriodoRepo, resultadoRepo,
            httpDatosRepo);

  @override
  void initListeners() {
    _presenter.getCalendarioPeridoOnComplete =
        (List<CalendarioPeriodoUI>? calendarioPeridoList,
    ...
    _presenter.getResultadosOnComplete =
        (MatrizResultadoUi? matrizResultadoUi, bool? offlineServidor,
        bool? errorServidor) {
      ...
      var result = TableResultadoUtils.getTableResulData(
          matrizResultadoUi, calendarioPeriodoUI);
