...
/*
class PortalTareaController2 extends Controller{
  UsuarioUi? usuarioUi;
  CursosUi? cursosUi;
  TareaUi? tareaUi;
  SesionUi? sesionUi;
  ...
  List<TareaAlumnoUi> _tareaAlumnoUiListAll = [];
  List<TareaAlumnoUi> get tareaAlumnoUiListAll => _tareaAlumnoUiListAll;
  ...
  PortalTareaController2(this.usuarioUi, this.cursosUi, this.tareaUi, this.calendarioPeriodoUI, this.unidadUi, this.sesionUi, HttpDatosRepository httpDatosRepo, UnidadTareaRepository unidadTareaRepo, ConfiguracionRepository configuracionRepo, RubroRepository rubroRepo):
  ...
  void initListeners() {
    ...
    presenter.getInformacionTareaOnComplete = (List<TareaAlumnoUi>? tareaAlumnoUiList, List<TareaRecusoUi>? tareaRecusoUiList, bool? offlineServidor, bool? errorServidor) async{
      ...
      _tareaAlumnoUiListAll = tareaAlumnoUiList??[];
      _tareaAlumnoUiList.clear();
      _tareaAlumnoUiList.addAll(_tareaAlumnoUiListAll);
    ...
    presenter.getRubroEvaluacionOnNext = (RubricaEvaluacionUi? rubricaEvalUI, List<PersonaUi> alumnoCursoList) async{
      ...
      for(PersonaUi item in alumnoCursoList){
        TareaAlumnoUi? tareaAlumnoUi = _tareaAlumnoUiListAll.firstWhereOrNull((element) => element.personaUi?.personaId == item.personaId);
      ...
      for(TareaAlumnoUi tareaAlumnoUi in _tareaAlumnoUiList){
        ...
        if(rubricaEvalUI?.rubroEvaluacionId == tareaAlumnoUi.rubroEvalProcesoId){
          ...
          tareaAlumnoUi.valorTipoNotaId = null;
          tareaAlumnoUi.nota = null;
        }
      }

      _mostrarAlumnosDosListas = _tareaAlumnoUiNoEvaluadosList.isNotEmpty && _tareaAlumnoUiEvaluadosList.isNotEmpty;
      print("_mostrarAlumnosDosListas: ${_mostrarAlumnosDosListas}");
      ...
      refreshCountEvaluados();
      notifyListeners();
      print("_mostrarAlumnosDosListas: refreshUI");
    };
  ...
  Future<void> initLista(List<PersonaUi> alumnoCursoList, RubricaEvaluacionUi? rubricaEvalUI) async{
    ...
    for(TareaAlumnoUi tareaAlumnoUi in _tareaAlumnoUiList){
      ...
      for(RubricaEvaluacionUi row in _mapRowList[tareaAlumnoUi]??[]){
        ...
        EvaluacionUi? evaluacionUi = row.evaluacionUiList?.firstWhereOrNull((element) => element.alumnoId == tareaAlumnoUi.personaUi?.personaId);
