...
/*
  static TransformarValoTipoNotaResponse execute(
      TransformarValoTipoNotaParams params) {
    ValorTipoNotaUi? valorTipoNotaUi = null;
    double notaRubro = DomainTools.transformacionInvariante(
        params.notaValorMinimo.toDouble(), params.notaValorMaximo.toDouble(),
        params.nota ?? 0.0,
        params.tipoNotaUi?.escalavalorMinimo?.toDouble() ?? 0.0,
        params.tipoNotaUi?.escalavalorMaximo?.toDouble() ?? 0.0);
    if (params.tipoNotaUi?.tipoNotaTiposUi ==
        TipoNotaTiposUi.SELECTOR_VALORES ||
        params.tipoNotaUi?.tipoNotaTiposUi == TipoNotaTiposUi.SELECTOR_ICONOS) {
