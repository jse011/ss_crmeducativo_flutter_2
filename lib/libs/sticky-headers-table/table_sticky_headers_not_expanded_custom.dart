...
class StickyHeadersTableNotExpandedCustom extends StatefulWidget {
  StickyHeadersTableNotExpandedCustom({
    Key? key,
...
class _StickyHeadersTableState extends State<StickyHeadersTableNotExpandedCustom> {
